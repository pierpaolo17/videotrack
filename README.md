...
Current release documented by this tree: **1.7.114**. Supported Moodle branches declared by the plugin: **5.0–5.3**.
...
Database/ER schema: [`docs/VIDEOTRACK_DB_ER_SCHEMA.md`](docs/VIDEOTRACK_DB_ER_SCHEMA.md)

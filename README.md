...
Current release documented by this tree: **1.7.42**. Supported Moodle branches declared by the plugin: **5.0–5.3**.

Italian overview: [`README_IT.md`](README_IT.md)
Release history: [`CHANGELOG.md`](CHANGELOG.md)
Consolidated 1.7.5–1.7.42 history/lessons/roadmap: [`VIDEOTRACK_CHANGELOG_LESSONS_ROADMAP_1.7.5_1.7.42.md`](VIDEOTRACK_CHANGELOG_LESSONS_ROADMAP_1.7.5_1.7.42.md)

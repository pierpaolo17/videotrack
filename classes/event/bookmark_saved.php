...
/**
 * Fired when a student saves a private video bookmark.
 *
 * @package    mod_videotrack
 * @copyright  2026 videotrack contributors
 * @license    https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class bookmark_saved extends \core\event\base {
    /**
    ...
    public static function get_name(): string {
        return get_string('event:bookmark_saved', 'mod_videotrack');
    }
    ...
    public function get_description(): string {
        return "The user with id '{$this->userid}' saved a private bookmark with id '{$this->objectid}' " .

...
if ($ADMIN->fulltree) {
    ...
    if (!function_exists('imagecreatefromstring')) {
        $settings->add(new admin_setting_heading('mod_videotrack/gd_missing_warning',
            '',
            html_writer::div(html_writer::tag('strong',
    ...
    $settings->add(new admin_setting_heading('mod_videotrack/heading_privacy',
    ...
    if ($retentiondays === 0) {
        $settings->add(new admin_setting_heading('mod_videotrack/retention_unlimited_warning',
            '',
            html_writer::div(html_writer::tag('strong', get_string('setting:retentionunlimitedwarning_title', 'mod_videotrack')) . ' ' .
                get_string('setting:retentionunlimitedwarning_desc', 'mod_videotrack'),
                'alert alert-warning')));
    }

    $settings->add(new admin_setting_configcheckbox('mod_videotrack/retentionunlimitedconfirmed',
    ...
    $settings->add(new \mod_videotrack\admin\setting_retention_days('mod_videotrack/retentionperioddays',
    ...
    $settings->add(new admin_setting_configcheckbox('mod_videotrack/strictsessionvalidation',
    ...
    $validationfallbackdesc = get_string('setting:validationfallbackdays_desc', 'mod_videotrack') . ' ' .
        html_writer::span(get_string('setting:validationfallbackdays_privacywarning', 'mod_videotrack'),
            'text-warning fw-semibold');
    $settings->add(new \mod_videotrack\admin\setting_int_range('mod_videotrack/validationfallbackdays',
    ...
    // Performance.
    $settings->add(new admin_setting_heading('mod_videotrack/heading_performance',
        get_string('setting:heading_performance', 'mod_videotrack'),
        ''));

    $settings->add(new \mod_videotrack\admin\setting_int_range('mod_videotrack/heartbeatinterval',
    ...
    $settings->add(new \mod_videotrack\admin\setting_int_range('mod_videotrack/reportclusterlimit',
    ...
    $settings->add(new \mod_videotrack\admin\setting_int_range('mod_videotrack/reportnotespagesize',
    ...
    $settings->add(new admin_setting_heading('mod_videotrack/heading_accessibility',
    ...
    $settings->add(new \mod_videotrack\admin\setting_int_range('mod_videotrack/reactionannouncementinterval',
    ...
    $settings->add(new \mod_videotrack\admin\setting_int_range('mod_videotrack/reactionreadydebouncems',
    ...
    $settings->add(new \mod_videotrack\admin\setting_int_range('mod_videotrack/statusinfotimeoutms',
    ...
    $settings->add(new \mod_videotrack\admin\setting_int_range('mod_videotrack/statuserrortimeoutms',
    ...
    // Player behaviour.
    $settings->add(new admin_setting_heading('mod_videotrack/heading_player',
    ...
    $settings->add(new admin_setting_configmultiselect('mod_videotrack/playbackspeeds',
    ...
    $settings->add(new admin_setting_configselect('mod_videotrack/maxplaybackrate',
    ...
    $settings->add(new admin_setting_configcheckbox('mod_videotrack/distractionfree',
    ...
    $settings->add(new admin_setting_configcheckbox('mod_videotrack/resumeplayback',
    ...
    $settings->add(new admin_setting_configcheckbox('mod_videotrack/studentnotesenabled',
        get_string('setting:studentnotesenabled', 'mod_videotrack'),
        get_string('setting:studentnotesenabled_desc', 'mod_videotrack'),
        0));

    $settings->add(new \mod_videotrack\admin\setting_int_range('mod_videotrack/notemaxlength',
    ...
    $settings->add(new admin_setting_heading('mod_videotrack/heading_playerbehavior',
        get_string('setting:heading_playerbehavior', 'mod_videotrack'),
        get_string('setting:heading_playerbehavior_desc', 'mod_videotrack')));

    // Max player width.
    $settings->add(new \mod_videotrack\admin\setting_int_range('mod_videotrack/playerwidth',
    ...
    $settings->add(new admin_setting_configcheckbox('mod_videotrack/default_autoplay',
        get_string('autoplay', 'mod_videotrack'),
        get_string('setting:default_desc', 'mod_videotrack'),
        0));

    $settings->add(new admin_setting_configcheckbox('mod_videotrack/default_loop',
        get_string('loop', 'mod_videotrack'),
        get_string('setting:default_desc', 'mod_videotrack'),
        0));

    $settings->add(new admin_setting_configcheckbox('mod_videotrack/default_startmuted',
        get_string('startmuted', 'mod_videotrack'),
        get_string('setting:default_desc', 'mod_videotrack'),
        0));

    $settings->add(new admin_setting_configcheckbox('mod_videotrack/default_allowdownload',
    ...
    $settings->add(new \mod_videotrack\admin\setting_int_range('mod_videotrack/rewindstep',
    ...
    $settings->add(new \mod_videotrack\admin\setting_int_range('mod_videotrack/fastforwardstep',
    ...
    // Captions / subtitles.
    $settings->add(new admin_setting_configcheckbox('mod_videotrack/default_captions',
        get_string('captions', 'mod_videotrack'),
        get_string('setting:default_captions_desc', 'mod_videotrack'),
        0));

    $settings->add(new admin_setting_configtext('mod_videotrack/default_captionslang',
    ...
    $settings->add(new admin_setting_heading('mod_videotrack/heading_html5controls',
    ...
    $html5controloptions = [
        ...
        'pip'         => get_string('ctrl:pip',
            'mod_videotrack'),
        'fullscreen'  => get_string('ctrl:fullscreen',
            'mod_videotrack'),
        'download'    => get_string('ctrl:download',
            'mod_videotrack'),
    ];
    $settings->add(new admin_setting_configmultiselect('mod_videotrack/html5controls',
    ...
    $settings->add(new admin_setting_heading('mod_videotrack/heading_defaults',
        get_string('setting:heading_defaults', 'mod_videotrack'),
        get_string('setting:heading_defaults_desc', 'mod_videotrack')));

    $settings->add(new admin_setting_configcheckbox('mod_videotrack/default_showcontrols',
        get_string('showcontrols', 'mod_videotrack'),
        get_string('setting:default_desc', 'mod_videotrack'),
        1));

    $settings->add(new admin_setting_configcheckbox('mod_videotrack/default_showfullscreen',
        get_string('showfullscreen', 'mod_videotrack'),
        get_string('setting:default_desc', 'mod_videotrack'),
        1));

    $settings->add(new admin_setting_configcheckbox('mod_videotrack/default_disablekeyboard',
        get_string('disablekeyboard', 'mod_videotrack'),
        get_string('setting:default_desc', 'mod_videotrack'),
        0));

    $settings->add(new admin_setting_configcheckbox('mod_videotrack/default_allowseekforward',
        get_string('allowseekforward', 'mod_videotrack'),
        get_string('setting:default_desc', 'mod_videotrack'),
        1));

    $settings->add(new admin_setting_configcheckbox('mod_videotrack/default_allowseekbackward',
        get_string('allowseekbackward', 'mod_videotrack'),
        get_string('setting:default_desc', 'mod_videotrack'),
        1));

    $settings->add(new admin_setting_configcheckbox('mod_videotrack/default_allowplaybackratechange',
        get_string('allowplaybackratechange', 'mod_videotrack'),
        get_string('setting:default_desc', 'mod_videotrack'),
        1));

    $settings->add(new admin_setting_configtext('mod_videotrack/default_completionpercent',
        get_string('completionpercent', 'mod_videotrack'),
        get_string('setting:default_completionpercent_desc', 'mod_videotrack'),
        0,
        PARAM_INT));

    $settings->add(new admin_setting_configselect('mod_videotrack/default_clusterwindow',
    ...
    $settings->add(new admin_setting_heading('mod_videotrack/heading_presets',
    ...
    $settings->add(new admin_setting_heading('mod_videotrack/presets_link',
        '',

...
Release corrente documentata da questo albero: **1.7.115**. Rami Moodle dichiarati come supportati dal plugin: **5.0–5.3**.
...
Schema database/ER: [`docs/VIDEOTRACK_DB_ER_SCHEMA.md`](docs/VIDEOTRACK_DB_ER_SCHEMA.md)

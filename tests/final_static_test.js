...
function main() {
    ...
    assertContains('version.php', /\$plugin->version\s*=\s*202605250(?:79|80|81);/, 'final-check plugin version');
    assertContains('version.php', /\$plugin->release\s*=\s*'(?:1\.3\.79|1\.3\.80|1\.3\.81)'/, 'final-check release marker');

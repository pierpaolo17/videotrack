...
$string['integrity:pauseonfocusloss_desc'] = 'Pausa la reproducción cuando la pestaña queda oculta o la ventana pierde el foco. El foco también puede perderse al usar controles del navegador o diálogos del sistema.';
...
$string['integrity:randompauses_desc'] = 'Mientras el vídeo se reproduce, lo pausa tras un intervalo aleatorio de 301 a 1799 segundos desde la última interacción. El alumnado reanuda la reproducción manualmente.';
$string['integrity:studentnotice'] = 'Esta actividad puede utilizar controles de atención e indicadores de diagnóstico respetuosos con la privacidad. La reproducción puede pausarse al perder el foco o tras un intervalo aleatorio. Son señales contextuales, no pruebas automáticas de conducta indebida.';
$string['integrity:focuspaused'] = 'La reproducción se pausó porque la página del vídeo perdió el foco. Vuelve al vídeo y pulsa Reproducir.';

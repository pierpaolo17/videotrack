...
$string['acknowledgement:text_help'] = 'Enter the statement learners must read and explicitly confirm. The confirmation stores the date, the activity version and a non-reversible hash of this statement.';
...
$string['acknowledgement:privacyhint'] = 'VideoTrack records the confirmation date and the version of the statement. This confirms receipt only; it does not assess understanding.';

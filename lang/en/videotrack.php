...
$string['integrity:pauseonfocusloss_desc'] = 'Pause playback when the browser tab becomes hidden or the browser window loses focus. Window focus may also be lost when the learner uses browser chrome or an operating-system dialog.';
...
$string['integrity:randompauses_desc'] = 'While the video is playing, pause it after a random interval of 301 to 1799 seconds since the learner\'s last interaction. The learner resumes playback manually.';
$string['integrity:studentnotice'] = 'This activity may use focus controls and privacy-safe diagnostic indicators. Playback can pause when the page loses focus or after a random interval. The indicators are contextual signals, not automatic proof of misconduct.';
$string['integrity:focuspaused'] = 'Playback was paused because the video page lost focus. Return to the video and press Play to continue.';

...
$string['completionreactionrules_desc'] = 'Reaction-based completion criteria are configured in the Reactions section. Minimum distinct reactions, reactions marked as required for completion, and the rule requiring every configured reaction type all participate in automatic activity completion.';

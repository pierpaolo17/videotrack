...
$string['bookmarks_student_heading'] = 'Student bookmarks';
...
$string['focus:exceptiongroupdescription'] = 'Members use the hidden-only focus policy when the site policy is strict. Hidden tabs and all server-side playback validation remain enforced.';
$string['focus:exceptiongroupname'] = 'VideoTrack - focus exceptions';
...
$string['forum:studentheading'] = 'Post in the forum';
$string['forum:studenthelp'] = 'Click the button to open the forum selected by the teacher, where you can create a post linked to a precise point in the video.';
...
$string['report:cumulative_privacy_suppressed'] = 'Cumulative details are hidden because this selection contains fewer than {$a} distinct learners.';
...
$string['seekforwardblockedlabel'] = 'Forward seeking is not allowed for this activity. The video was returned to the last allowed position.';
$string['seekforwardblockedspeedlabel'] = 'Playback will continue at {$a}×.';
$string['seekforwarddisabledlabel'] = 'Forward seeking is disabled by the teacher for this activity.';
$string['seekforwarddisabledspeedlabel'] = 'The configured recovery rate after a blocked attempt is {$a}×.';
...
$string['setting:analyticsminusers_desc'] = 'Minimum number of distinct users required before privacy-masked aggregate summaries outside the exact Analytics dashboards can display exact values. Instance, course and teacher Analytics dashboards are exact for authorised report viewers and do not use this threshold. Allowed range: 2–50.';
...
$string['studentnotesheader'] = 'Student notes';
...
$string['videotrack:exportaggregatereport'] = 'Export aggregated VideoTrack reports';
$string['videotrack:exportindividualreport'] = 'Export individual VideoTrack reports';
...
$string['videotrack:viewaggregatereport'] = 'View aggregated VideoTrack reports';
...
$string['videotrack:viewindividualreport'] = 'View individual VideoTrack reports';

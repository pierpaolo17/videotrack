...
$string['report:csvexport_format_help'] = 'Summary mode groups each student’s reactions using the configured {$a}-second cluster window. Notes remain individual rows.';

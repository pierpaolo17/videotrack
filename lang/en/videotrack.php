...
$string['privacy:metadata:videotrack_state:serverlastactivity'] = 'Server timestamp of the last accepted tracking update used by the playback credit guard.';
...
$string['privacy_cleanup_anonymised'] = 'VideoTrack GDPR retention: anonymised {$a->segments} segments, {$a->states} states, {$a->events} interaction events and {$a->integrity} integrity signals; deleted {$a->acknowledgements} expired acknowledgements across {$a->processed} user/activity pairs.';

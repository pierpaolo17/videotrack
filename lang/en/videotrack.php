...
$string['transcriptfiles'] = 'Transcript files (.vtt)';
$string['transcriptfiles_help'] = 'Upload up to ten WebVTT transcript files. Name language files with a language code such as en.vtt, it.vtt or pt-BR.vtt. Transcript files are independent from player captions and work with all video sources.';

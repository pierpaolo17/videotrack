...
$string['setting:reactionannouncementinterval_desc'] = 'Minimum interval, in seconds, between repeated “reactions unavailable” screen-reader announcements. Use a lower value for frequent feedback in short videos, or a higher value to reduce repeated announcements. Set to 0 to disable repeated announcements. Recommended range when enabled: 10–60 seconds.';
$string['setting:reactionreadydebouncems'] = 'Reaction ready debounce (milliseconds)';
$string['setting:reactionreadydebouncems_desc'] = 'Minimum delay, in milliseconds, before repeating reaction-ready feedback after rapid playback changes. Set to 0 to disable this debounce.';

...
$string['setting:retentionperioddays_desc'] = 'Number of days after which VideoTrack anonymises old tracking, notes and reaction data for retention cleanup. Set to 0 to retain data indefinitely. User erasure requests handled through the Moodle Privacy API permanently delete the user\'s tracking, state, reaction and note records for the selected context.';

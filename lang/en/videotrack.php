...
$string['privacy_cleanup_anonymised'] = 'VideoTrack GDPR retention: anonymised {$a->segments} segments, {$a->states} states, {$a->events} reaction/note events and {$a->integrity} integrity signals across {$a->processed} user/activity pairs.';

...
$string['report:csvexport_overall'] = 'Overall: clusters across all students and individual notes';
$string['report:csvexport_format_help'] = 'Summary mode groups reactions per student. Overall mode groups all students’ reactions together and always uses the whole course. Both use the configured {$a}-second cluster window; notes remain individual rows.';

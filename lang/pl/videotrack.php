...
$string['integrity:pauseonfocusloss_desc'] = 'Wstrzymuje odtwarzanie po ukryciu karty lub utracie fokusu przez okno. Fokus może zostać utracony także podczas korzystania z interfejsu przeglądarki lub okna systemowego.';
...
$string['integrity:randompauses_desc'] = 'Podczas odtwarzania wstrzymuje film po losowym czasie od 301 do 1799 sekund od ostatniej interakcji. Uczeń ręcznie wznawia odtwarzanie.';
$string['integrity:studentnotice'] = 'Ta aktywność może używać kontroli uwagi i diagnostycznych wskaźników chroniących prywatność. Odtwarzanie może zostać wstrzymane po utracie fokusu lub po losowym czasie. Są to wskazówki kontekstowe, a nie automatyczny dowód niewłaściwego zachowania.';
$string['integrity:focuspaused'] = 'Odtwarzanie wstrzymano, ponieważ strona filmu utraciła fokus. Wróć do filmu i naciśnij Odtwórz.';

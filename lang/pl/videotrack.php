...
$string['setting:reactionannouncementinterval_desc'] = 'Minimalny czas między powtarzanymi komunikatami czytnika ekranu „reakcje niedostępne”. Użyj niższej wartości dla częstszego feedbacku w krótkich filmach albo wyższej, aby ograniczyć powtarzanie komunikatów. Ustaw 0, aby wyłączyć powtarzane komunikaty. Zalecany zakres po włączeniu: 10–60 sekund.';
$string['setting:reactionreadydebouncems'] = 'Opóźnienie gotowości reakcji (milisekundy)';
$string['setting:reactionreadydebouncems_desc'] = 'Minimalne opóźnienie przed powtórzeniem informacji, że reakcje są dostępne, po szybkich zmianach odtwarzania. Ustaw 0, aby wyłączyć opóźnienie.';

...
$string['setting:reactionannouncementinterval_desc'] = 'Minimalny odstęp, w sekundach, między powtarzanymi komunikatami czytnika ekranu „reakcje niedostępne”. Użyj niższej wartości dla częstszego feedbacku w krótkich filmach albo wyższej, aby ograniczyć powtarzane komunikaty. Ustaw 0, aby wyłączyć powtarzane komunikaty. Zalecany zakres po włączeniu: 10–60 sekund.';
$string['setting:reactionreadydebouncems'] = 'Opóźnienie gotowości reakcji (milisekundy)';
$string['setting:reactionreadydebouncems_desc'] = 'Minimalne opóźnienie, w milisekundach, przed ponownym ogłoszeniem dostępności reakcji po szybkich zmianach odtwarzania. Ustaw 0, aby wyłączyć ten debounce.';

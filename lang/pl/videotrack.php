...
$string['privacy_cleanup_anonymised'] = 'Retencja RODO w VideoTrack: zanonimizowano {$a->segments} segmentów, {$a->states} stanów, {$a->events} zdarzeń reakcji/notatek i {$a->integrity} sygnałów integralności w {$a->processed} parach użytkownik/aktywność.';

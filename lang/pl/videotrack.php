...
$string['report:csvexport_overall'] = 'Łączne: klastry wszystkich studentów i pojedyncze notatki';
$string['report:csvexport_format_help'] = 'Tryb szczegółowy zapisuje jeden wiersz na zdarzenie. Tryb podsumowania grupuje reakcje według studenta. Tryb łączny grupuje razem reakcje wszystkich studentów i zawsze obejmuje cały kurs. Oba tryby używają skonfigurowanego okna klastra {$a} sekund; notatki pozostają osobnymi wierszami.';

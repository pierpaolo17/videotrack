...
$string['transcriptfiles'] = 'Pliki transkrypcji (.vtt)';
$string['transcriptfiles_help'] = 'Prześlij do dziesięciu plików WebVTT transkrypcji. Nazwij pliki kodem języka, np. en.vtt, pl.vtt lub pt-BR.vtt. Działają ze wszystkimi źródłami wideo.';

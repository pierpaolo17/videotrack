...
$string['report:csvexport_overall'] = 'Complessiva: cluster di tutti gli studenti e note individuali';
$string['report:csvexport_format_help'] = 'La modalità sintetica raggruppa le reazioni per studente. La modalità complessiva raggruppa insieme le reazioni di tutti gli studenti e usa sempre l’intero corso. Entrambe usano la finestra cluster di {$a} secondi; le note restano righe individuali.';

...
$string['setting:retentionperioddays_desc'] = 'Numero di giorni dopo i quali VideoTrack anonimizza i dati vecchi di tracciamento, note e reazioni per la retention automatica. Imposta 0 per conservare i dati senza scadenza. Le richieste di oblio gestite dalla Privacy API di Moodle eliminano definitivamente i record di tracciamento, stato, reazioni e note dell\'utente nel contesto selezionato.';

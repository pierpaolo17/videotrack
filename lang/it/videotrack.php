...
$string['privacy_cleanup_anonymised'] = 'Retention GDPR di VideoTrack: anonimizzati {$a->segments} segmenti, {$a->states} stati, {$a->events} eventi di interazione e {$a->integrity} segnali di integrità; eliminate {$a->acknowledgements} prese visione scadute su {$a->processed} coppie utente/attività.';

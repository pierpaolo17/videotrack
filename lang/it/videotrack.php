...
$string['integrity:pauseonfocusloss_desc'] = 'Mette in pausa la riproduzione quando la scheda del browser viene nascosta o la finestra perde il focus. Il focus può essere perso anche quando lo studente usa i comandi del browser o una finestra di sistema.';
...
$string['integrity:randompauses_desc'] = 'Durante la riproduzione, mette in pausa il video dopo un intervallo casuale compreso tra 301 e 1799 secondi dall’ultima interazione dello studente. Lo studente riprende manualmente la riproduzione.';
$string['integrity:studentnotice'] = 'Questa attività può usare controlli del focus e indicatori diagnostici rispettosi della privacy. La riproduzione può interrompersi quando la pagina perde il focus o dopo un intervallo casuale. Gli indicatori sono segnali contestuali, non prove automatiche di comportamento scorretto.';
$string['integrity:focuspaused'] = 'La riproduzione è stata messa in pausa perché la pagina del video ha perso il focus. Torna al video e premi Riproduci per continuare.';

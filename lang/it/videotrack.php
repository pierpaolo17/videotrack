...
$string['setting:reactionannouncementinterval_desc'] = 'Intervallo minimo, in secondi, tra annunci ripetuti “reazioni non disponibili” per screen reader. Usa un valore più basso per feedback frequenti nei video brevi o più alto per ridurre annunci ripetuti. Imposta 0 per disabilitare gli annunci ripetuti. Intervallo consigliato quando attivo: 10–60 secondi.';
$string['setting:reactionreadydebouncems'] = 'Debounce per reazioni pronte (millisecondi)';
$string['setting:reactionreadydebouncems_desc'] = 'Ritardo minimo, in millisecondi, prima di ripetere il feedback di reazioni pronte dopo cambi rapidi di riproduzione. Imposta 0 per disabilitare il debounce.';

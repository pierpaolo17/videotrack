...
$string['privacy_cleanup_anonymised'] = 'Retention GDPR di VideoTrack: anonimizzati {$a->segments} segmenti, {$a->states} stati, {$a->events} eventi reazione/nota e {$a->integrity} segnali di integrità su {$a->processed} coppie utente/attività.';

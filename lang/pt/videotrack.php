...
$string['setting:retentionperioddays_desc'] = 'Numero de dias apos os quais o VideoTrack anonimiza dados antigos de acompanhamento, notas e reacoes para a retencao automatica. Defina 0 para conservar os dados indefinidamente. Os pedidos de apagamento tratados pela Privacy API do Moodle eliminam permanentemente os registos de acompanhamento, estado, reacoes e notas do utilizador no contexto selecionado.';

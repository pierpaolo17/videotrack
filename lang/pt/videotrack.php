...
$string['report:csvexport_overall'] = 'Global: clusters de todos os estudantes e notas individuais';
$string['report:csvexport_format_help'] = 'O modo detalhado escreve uma linha por evento. O modo sintético agrupa as reações por estudante. O modo global agrupa em conjunto as reações de todos os estudantes e utiliza sempre todo o curso. Ambos usam a janela de cluster configurada de {$a} segundos; as notas permanecem linhas individuais.';

...
$string['integrity:pauseonfocusloss_desc'] = 'Pausa a reprodução quando o separador fica oculto ou a janela perde o foco. O foco também pode ser perdido ao usar controlos do navegador ou diálogos do sistema.';
...
$string['integrity:randompauses_desc'] = 'Durante a reprodução, pausa o vídeo após um intervalo aleatório de 301 a 1799 segundos desde a última interação. O estudante retoma manualmente.';
$string['integrity:studentnotice'] = 'Esta atividade pode usar controlos de atenção e indicadores de diagnóstico que respeitam a privacidade. A reprodução pode pausar ao perder o foco ou após um intervalo aleatório. São sinais contextuais, não provas automáticas de conduta indevida.';
$string['integrity:focuspaused'] = 'A reprodução foi pausada porque a página do vídeo perdeu o foco. Volte ao vídeo e prima Reproduzir.';

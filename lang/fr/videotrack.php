...
$string['setting:retentionperioddays_desc'] = 'Nombre de jours après lesquels VideoTrack anonymise les anciennes données de suivi, notes et réactions. Définissez 0 pour conserver les données indéfiniment. Les demandes d’effacement utilisateur sont toujours traitées par anonymisation salée plutôt que par suppression des analyses agrégées.';

...
$string['setting:retentionperioddays_desc'] = 'Nombre de jours apres lesquels VideoTrack anonymise les anciennes donnees de suivi, notes et reactions pour la retention automatique. Definissez 0 pour conserver les donnees indefiniment. Les demandes d\'effacement traitees par l\'API de confidentialite de Moodle suppriment definitivement les enregistrements de suivi, d\'etat, de reactions et de notes de l\'utilisateur dans le contexte selectionne.';

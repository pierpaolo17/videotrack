...
$string['report:csvexport_overall'] = 'Globale : groupes de tous les étudiants et notes individuelles';
$string['report:csvexport_format_help'] = 'Le mode détaillé écrit une ligne par événement. Le mode synthétique regroupe les réactions par étudiant. Le mode global regroupe ensemble les réactions de tous les étudiants et utilise toujours tout le cours. Les deux utilisent la fenêtre de regroupement configurée de {$a} secondes ; les notes restent des lignes individuelles.';

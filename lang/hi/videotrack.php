...
$string['setting:reactionannouncementinterval_desc'] = 'स्क्रीन रीडर के लिए दोहराई गई “प्रतिक्रियाएँ उपलब्ध नहीं हैं” घोषणाओं के बीच न्यूनतम अंतराल, सेकंड में। छोटे वीडियो में बार-बार प्रतिक्रिया के लिए कम मान या दोहराई गई घोषणाएँ कम करने के लिए अधिक मान उपयोग करें। दोहराई गई घोषणाएँ बंद करने के लिए 0 सेट करें। सक्षम होने पर अनुशंसित सीमा: 10–60 सेकंड।';
$string['setting:reactionreadydebouncems'] = 'तैयार प्रतिक्रियाओं का डिबाउंस (मिलीसेकंड)';
$string['setting:reactionreadydebouncems_desc'] = 'तेज़ प्लेबैक बदलावों के बाद प्रतिक्रिया तैयार होने का फ़ीडबैक दोहराने से पहले न्यूनतम विलंब, मिलीसेकंड में। डिबाउंस बंद करने के लिए 0 सेट करें।';
...
$string['setting:retentionperioddays_desc'] = 'दिनों की संख्या जिसके बाद VideoTrack पुराने ट्रैकिंग, नोट और प्रतिक्रिया डेटा को अनाम करता है। डेटा को अनिश्चितकाल तक रखने के लिए 0 सेट करें। उपयोगकर्ता मिटाने के अनुरोध हमेशा समेकित विश्लेषण हटाने के बजाय salted anonymisation द्वारा संभाले जाते हैं।';

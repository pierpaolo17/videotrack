...
$string['privacy_cleanup_anonymised'] = 'VideoTrack GDPR रिटेंशन: {$a->processed} उपयोगकर्ता/गतिविधि जोड़ों में {$a->segments} सेगमेंट, {$a->states} स्थिति रिकॉर्ड, {$a->events} प्रतिक्रिया/नोट ईवेंट और {$a->integrity} अखंडता संकेत अनामित किए गए।';

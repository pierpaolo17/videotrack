...
function xmldb_videotrack_upgrade($oldversion) {
    ...
    if ($oldversion < 2026070202) {
        // 1.1.2: JavaScript core utility fixes and event/endpoint cleanup. No schema changes.
    ...
    if ($oldversion < 2026070205) {
        // 1.1.5: documentation and coding-style cleanup. No schema changes.
    ...
    if ($oldversion < 2026070300) {
        // 1.2.0: production packaging cleanup, AMD build inclusion and documentation alignment. No schema changes.

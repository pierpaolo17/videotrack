...
| `serverplaybacksessionid` | `char`(64) | NOT NULL; no schema default | Browser playback session currently authorised to consume server credit; runtime writes the inactive empty value explicitly |

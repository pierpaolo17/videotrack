...
Variables are detected statically. The inventory is a navigation map; it does not replace runtime flow analysis.
...
## Forum configuration fields (1.5.0)
...
## Integrity and focus variables (1.6.18)

...
Reactions are allowed only in their configured playback/state contract. Notes and bookmarks require a timestamp already viewed by the owner. External services enforce feature enablement, ownership and maximum lengths. Deleted records retain a bounded tombstone until retention/erasure; private text is never copied into teacher aggregates.

...
Current documented release: **1.7.48** (`2026081305`).

Current consolidated release history: [`../../VIDEOTRACK_CHANGELOG_LESSONS_ROADMAP_1.7.5_1.7.48.md`](../../VIDEOTRACK_CHANGELOG_LESSONS_ROADMAP_1.7.5_1.7.48.md).
...
22. `22_BEHAT_BROWSER_TESTS.md` — Moodle Behat setup, current browser coverage and the remaining U-007 matrix.

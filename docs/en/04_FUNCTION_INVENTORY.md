...
Generated from the VideoTrack 1.7.146 source tree. PHP entries include named functions and methods; AMD entries include named declarations, assigned function expressions and object-method functions.
...
| `amd/src/core/api/validator.js:55` | `normaliseMethodName` | Named callable `normaliseMethodName` in the module; see its JSDoc and callers for parameter and side-effect details. |
| `amd/src/core/api/validator.js:73` | `createValidationError` | Named callable `createValidationError` in the module; see its JSDoc and callers for parameter and side-effect details. |
| `amd/src/core/api/validator.js:87` | `isPlainObject` | Named callable `isPlainObject` in the module; see its JSDoc and callers for parameter and side-effect details. |
| `amd/src/core/api/validator.js:97` | `getUtf8Length` | Named callable `getUtf8Length` in the module; see its JSDoc and callers for parameter and side-effect details. |
| `amd/src/core/api/validator.js:112` | `isSafeArgValue` | Named callable `isSafeArgValue` in the module; see its JSDoc and callers for parameter and side-effect details. |
| `amd/src/core/api/validator.js:150` | `hasNonNegativeNumber` | Named callable `hasNonNegativeNumber` in the module; see its JSDoc and callers for parameter and side-effect details. |
| `amd/src/core/api/validator.js:167` | `validateArgs` | Named callable `validateArgs` in the module; see its JSDoc and callers for parameter and side-effect details. |
...
| `backup/moodle2/backup_videotrack_stepslib.php:34` | `define_structure` | PHP callable `define_structure`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `backup/moodle2/restore_videotrack_activity_task.class.php:36` | `define_my_settings` | PHP callable `define_my_settings`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `backup/moodle2/restore_videotrack_activity_task.class.php:42` | `define_my_steps` | PHP callable `define_my_steps`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `backup/moodle2/restore_videotrack_activity_task.class.php:51` | `define_decode_contents` | PHP callable `define_decode_contents`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `backup/moodle2/restore_videotrack_activity_task.class.php:60` | `define_decode_rules` | PHP callable `define_decode_rules`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `backup/moodle2/restore_videotrack_activity_task.class.php:73` | `after_restore` | PHP callable `after_restore`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `backup/moodle2/restore_videotrack_stepslib.php:34` | `define_structure` | PHP callable `define_structure`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `backup/moodle2/restore_videotrack_stepslib.php:59` | `process_videotrack` | PHP callable `process_videotrack`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `backup/moodle2/restore_videotrack_stepslib.php:93` | `process_videotrack_reaction` | PHP callable `process_videotrack_reaction`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `backup/moodle2/restore_videotrack_stepslib.php:124` | `process_videotrack_segment` | PHP callable `process_videotrack_segment`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `backup/moodle2/restore_videotrack_stepslib.php:186` | `process_videotrack_state` | PHP callable `process_videotrack_state`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `backup/moodle2/restore_videotrack_stepslib.php:198` | `process_videotrack_reactionevent` | PHP callable `process_videotrack_reactionevent`; see its DocBlock and callers for parameter, return-value and side-effect details. |
...
| `classes/event/acknowledgement_confirmed.php:60` | `get_url` | PHP callable `get_url`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/event/acknowledgement_confirmed.php:69` | `get_objectid_mapping` | PHP callable `get_objectid_mapping`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/event/activity_completed.php:31` | `init` | PHP callable `init`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/event/activity_completed.php:42` | `get_name` | PHP callable `get_name`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/event/activity_completed.php:51` | `get_description` | PHP callable `get_description`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/event/activity_completed.php:63` | `get_url` | PHP callable `get_url`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/event/activity_completed.php:72` | `get_objectid_mapping` | PHP callable `get_objectid_mapping`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/event/bookmark_deleted.php:30` | `init` | PHP callable `init`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/event/bookmark_deleted.php:41` | `get_name` | PHP callable `get_name`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/event/bookmark_deleted.php:50` | `get_description` | PHP callable `get_description`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/event/bookmark_deleted.php:60` | `get_url` | PHP callable `get_url`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/event/bookmark_deleted.php:69` | `get_objectid_mapping` | PHP callable `get_objectid_mapping`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/event/bookmark_exported.php:30` | `init` | PHP callable `init`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/event/bookmark_exported.php:41` | `get_name` | PHP callable `get_name`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/event/bookmark_exported.php:50` | `get_description` | PHP callable `get_description`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/event/bookmark_exported.php:60` | `get_url` | PHP callable `get_url`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/event/bookmark_exported.php:67` | `validate_data` | PHP callable `validate_data`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/event/bookmark_exported.php:79` | `get_objectid_mapping` | PHP callable `get_objectid_mapping`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/event/bookmark_saved.php:30` | `init` | PHP callable `init`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/event/bookmark_saved.php:41` | `get_name` | PHP callable `get_name`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/event/bookmark_saved.php:50` | `get_description` | PHP callable `get_description`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/event/bookmark_saved.php:60` | `get_url` | PHP callable `get_url`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/event/bookmark_saved.php:69` | `get_objectid_mapping` | PHP callable `get_objectid_mapping`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/event/course_module_viewed.php:30` | `init` | PHP callable `init`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/event/note_deleted.php:30` | `init` | PHP callable `init`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/event/note_deleted.php:41` | `get_name` | PHP callable `get_name`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/event/note_deleted.php:50` | `get_description` | PHP callable `get_description`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/event/note_deleted.php:60` | `get_url` | PHP callable `get_url`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/event/note_deleted.php:69` | `get_objectid_mapping` | PHP callable `get_objectid_mapping`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/event/note_saved.php:32` | `init` | PHP callable `init`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/event/note_saved.php:43` | `get_name` | PHP callable `get_name`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/event/note_saved.php:52` | `get_description` | PHP callable `get_description`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/event/note_saved.php:64` | `get_url` | PHP callable `get_url`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/event/note_saved.php:73` | `get_objectid_mapping` | PHP callable `get_objectid_mapping`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/event/notes_exported.php:30` | `init` | PHP callable `init`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/event/notes_exported.php:41` | `get_name` | PHP callable `get_name`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/event/notes_exported.php:50` | `get_description` | PHP callable `get_description`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/event/notes_exported.php:62` | `get_url` | PHP callable `get_url`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/event/notes_exported.php:70` | `validate_data` | PHP callable `validate_data`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/event/notes_exported.php:94` | `get_objectid_mapping` | PHP callable `get_objectid_mapping`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/event/notes_exported.php:103` | `get_other_mapping` | PHP callable `get_other_mapping`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/event/reaction_deleted.php:30` | `init` | PHP callable `init`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/event/reaction_deleted.php:41` | `get_name` | PHP callable `get_name`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/event/reaction_deleted.php:50` | `get_description` | PHP callable `get_description`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/event/reaction_deleted.php:61` | `get_url` | PHP callable `get_url`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/event/reaction_deleted.php:70` | `get_objectid_mapping` | PHP callable `get_objectid_mapping`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/event/reaction_saved.php:30` | `init` | PHP callable `init`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/event/reaction_saved.php:41` | `get_name` | PHP callable `get_name`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/event/reaction_saved.php:50` | `get_description` | PHP callable `get_description`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/event/reaction_saved.php:65` | `get_url` | PHP callable `get_url`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/event/reaction_saved.php:74` | `get_objectid_mapping` | PHP callable `get_objectid_mapping`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/event/report_exported.php:30` | `init` | PHP callable `init`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/event/report_exported.php:41` | `get_name` | PHP callable `get_name`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/event/report_exported.php:50` | `get_description` | PHP callable `get_description`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/event/report_exported.php:61` | `get_url` | PHP callable `get_url`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/event/report_exported.php:68` | `validate_data` | PHP callable `validate_data`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/event/report_exported.php:86` | `get_objectid_mapping` | PHP callable `get_objectid_mapping`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/event/segment_saved.php:31` | `init` | PHP callable `init`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/event/segment_saved.php:42` | `get_name` | PHP callable `get_name`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/event/segment_saved.php:51` | `get_description` | PHP callable `get_description`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/event/segment_saved.php:63` | `get_url` | PHP callable `get_url`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/event/segment_saved.php:72` | `get_objectid_mapping` | PHP callable `get_objectid_mapping`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/event/student_progress_reset.php:30` | `init` | PHP callable `init`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/event/student_progress_reset.php:41` | `get_name` | PHP callable `get_name`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/event/student_progress_reset.php:50` | `get_description` | PHP callable `get_description`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/event/student_progress_reset.php:65` | `validate_data` | PHP callable `validate_data`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/event/student_progress_reset.php:82` | `get_url` | PHP callable `get_url`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/event/student_progress_reset.php:91` | `get_objectid_mapping` | PHP callable `get_objectid_mapping`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/external/delete_bookmark.php:44` | `execute_parameters` | PHP callable `execute_parameters`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/external/delete_bookmark.php:58` | `execute` | PHP callable `execute`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/external/delete_bookmark.php:91` | `execute_returns` | PHP callable `execute_returns`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/external/delete_note.php:44` | `execute_parameters` | PHP callable `execute_parameters`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/external/delete_note.php:65` | `execute` | PHP callable `execute`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/external/delete_note.php:118` | `execute_returns` | PHP callable `execute_returns`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/external/delete_reaction.php:45` | `execute_parameters` | PHP callable `execute_parameters`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/external/delete_reaction.php:62` | `execute` | PHP callable `execute`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/external/delete_reaction.php:133` | `execute_returns` | PHP callable `execute_returns`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/external/helper.php:43` | `require_ajax_sesskey` | PHP callable `require_ajax_sesskey`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/external/helper.php:55` | `validate_positive_id` | PHP callable `validate_positive_id`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/external/helper.php:75` | `validate_session_id` | PHP callable `validate_session_id`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/external/helper.php:88` | `validate_request_id` | PHP callable `validate_request_id`; see its DocBlock and callers for parameter, return-value and side-effect details. |
...
| `classes/external/save_reaction.php:311` | `execute_returns` | PHP callable `execute_returns`; see its DocBlock and callers for parameter, return-value and side-effect details. |
...
| `classes/external/start_playback.php:42` | `execute_parameters` | PHP callable `execute_parameters`; see its DocBlock and callers for parameter, return-value and side-effect details. |
...
| `classes/local/acknowledgement.php:82` | `requires_video_end` | PHP callable `requires_video_end`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/local/acknowledgement.php:94` | `statement_hash` | PHP callable `statement_hash`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/local/acknowledgement.php:108` | `progress_snapshot` | PHP callable `progress_snapshot`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/local/acknowledgement.php:133` | `has_reached_video_end` | PHP callable `has_reached_video_end`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/local/acknowledgement.php:156` | `can_confirm` | PHP callable `can_confirm`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/local/acknowledgement.php:172` | `analytics_summary` | PHP callable `analytics_summary`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/local/acknowledgement.php:232` | `current_record` | PHP callable `current_record`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/local/acknowledgement.php:256` | `confirm` | PHP callable `confirm`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/local/acknowledgement.php:316` | `current_records` | PHP callable `current_records`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/local/analytics.php:51` | `resolve_duration` | PHP callable `resolve_duration`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/local/analytics.php:69` | `default_bin_size` | PHP callable `default_bin_size`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/local/analytics.php:96` | `restrict_to_own_groups` | PHP callable `restrict_to_own_groups`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/local/analytics.php:107` | `normalise_bin_size` | PHP callable `normalise_bin_size`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/local/analytics.php:135` | `build` | PHP callable `build`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/local/analytics.php:238` | `build_from_states` | PHP callable `build_from_states`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/local/analytics.php:276` | `apply_privacy_threshold` | PHP callable `apply_privacy_threshold`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/local/analytics.php:336` | `count_summary` | PHP callable `count_summary`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/local/analytics.php:359` | `reaction_summary` | PHP callable `reaction_summary`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/local/analytics.php:371` | `cluster_reactions` | PHP callable `cluster_reactions`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/local/analytics.php:432` | `append_visible_reaction_cluster` | PHP callable `append_visible_reaction_cluster`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/local/analytics.php:461` | `add_user_intervals` | PHP callable `add_user_intervals`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/local/analytics.php:497` | `add_interval_to_map` | PHP callable `add_interval_to_map`; see its DocBlock and callers for parameter, return-value and side-effect details. |
...
| `classes/local/csv_export.php:93` | `delimiter_options_with_inherit` | PHP callable `delimiter_options_with_inherit`; returns the activity selector choices with explicit site-default inheritance. |
| `classes/local/csv_export.php:106` | `delimiter` | PHP callable `delimiter`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/local/csv_export.php:130` | `field_options` | PHP callable `field_options`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/local/csv_export.php:179` | `form_field_options` | PHP callable `form_field_options`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/local/csv_export.php:205` | `site_default_fields` | PHP callable `site_default_fields`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/local/csv_export.php:220` | `activity_fields` | PHP callable `activity_fields`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/local/csv_export.php:235` | `form_element_name` | PHP callable `form_element_name`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/local/csv_export.php:246` | `process_form_fields` | PHP callable `process_form_fields`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/local/csv_export.php:266` | `selected_user_fields` | PHP callable `selected_user_fields`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/local/csv_export.php:279` | `load_users` | PHP callable `load_users`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/local/csv_export.php:313` | `event_headers` | PHP callable `event_headers`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/local/csv_export.php:336` | `identity_headers` | PHP callable `identity_headers`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/local/csv_export.php:366` | `identity_values` | PHP callable `identity_values`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/local/csv_export.php:407` | `cluster_notes` | PHP callable `cluster_notes`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/local/csv_export.php:457` | `write_utf8_bom` | PHP callable `write_utf8_bom`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/local/csv_export.php:469` | `write_row` | PHP callable `write_row`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/local/csv_export.php:494` | `safe_value` | PHP callable `safe_value`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/local/csv_export.php:511` | `normalise_field_list` | PHP callable `normalise_field_list`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/local/csv_export.php:525` | `field_label` | PHP callable `field_label`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/local/csv_export.php:543` | `field_value` | PHP callable `field_value`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/local/csv_export.php:580` | `video_url` | PHP callable `video_url`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/local/focus_policy.php:39` | `exception_group` | Returns the course-local hidden focus-exception group when it exists. |
| `classes/local/focus_policy.php:60` | `ensure_exception_group` | Idempotently creates or repairs the hidden, non-participating exception group. |
...
| `classes/local/integrity.php:126` | `focus_loss_grace_seconds` | PHP callable `focus_loss_grace_seconds`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/local/integrity.php:139` | `validate_event_type` | PHP callable `validate_event_type`; see its DocBlock and callers for parameter, return-value and side-effect details. |
...
| `classes/local/privacy_manager.php:94` | `delete_user_data_in_context` | PHP callable `delete_user_data_in_context`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/local/privacy_manager.php:121` | `delete_all_user_data_in_context` | PHP callable `delete_all_user_data_in_context`; see its DocBlock and callers for parameter, return-value and side-effect details. |
...
| `classes/local/tracker.php:129` | `encode_intervals` | PHP callable `encode_intervals`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/local/tracker.php:139` | `merge_intervals` | PHP callable `merge_intervals`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/local/tracker.php:166` | `cap_intervals` | PHP callable `cap_intervals`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/local/tracker.php:189` | `simplify_intervals` | PHP callable `simplify_intervals`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/local/tracker.php:212` | `covered_seconds` | PHP callable `covered_seconds`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/local/tracker.php:233` | `normalise_start_boundary` | PHP callable `normalise_start_boundary`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/local/tracker.php:257` | `normalise_natural_end` | PHP callable `normalise_natural_end`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/local/tracker.php:275` | `reaction_counts` | PHP callable `reaction_counts`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/local/tracker.php:317` | `invalidate_reactioncountscache` | PHP callable `invalidate_reactioncountscache`; see its DocBlock and callers for parameter, return-value and side-effect details. |
...
| `db/repairlib.php:118` | `videotrack_repair_preproduction_merge_grade_grades` | Named PHP function/method `videotrack_repair_preproduction_merge_grade_grades`; see source DocBlock and callers for the current contract. |
| `db/repairlib.php:148` | `videotrack_repair_preproduction_delete_grade_items` | Named PHP function/method `videotrack_repair_preproduction_delete_grade_items`; see source DocBlock and callers for the current contract. |
| `db/repairlib.php:169` | `videotrack_repair_preproduction_schema` | Named PHP function/method `videotrack_repair_preproduction_schema`; see source DocBlock and callers for the current contract. |
| `db/repairlib.php:236` | `videotrack_repair_preproduction_add_field` | Named PHP function/method `videotrack_repair_preproduction_add_field`; see source DocBlock and callers for the current contract. |
...
| `lib.php:147` | `videotrack_update_instance` | PHP callable `videotrack_update_instance`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `lib.php:215` | `videotrack_process_forum_fields` | PHP callable `videotrack_process_forum_fields`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `lib.php:234` | `videotrack_process_acknowledgement_fields` | PHP callable `videotrack_process_acknowledgement_fields`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `lib.php:261` | `videotrack_process_video_fields` | PHP callable `videotrack_process_video_fields`; see its DocBlock and callers for parameter, return-value and side-effect details. |
...
| `lib.php:398` | `videotrack_get_module_context_from_data` | PHP callable `videotrack_get_module_context_from_data`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `lib.php:421` | `videotrack_save_poster_image` | PHP callable `videotrack_save_poster_image`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `lib.php:454` | `videotrack_is_valid_reaction_icon_class` | PHP callable `videotrack_is_valid_reaction_icon_class`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `lib.php:489` | `videotrack_save_reaction_definitions` | PHP callable `videotrack_save_reaction_definitions`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `lib.php:636` | `videotrack_user_outline` | PHP callable `videotrack_user_outline`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `lib.php:665` | `videotrack_user_complete` | PHP callable `videotrack_user_complete`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `lib.php:706` | `videotrack_extend_settings_navigation` | PHP callable `videotrack_extend_settings_navigation`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `lib.php:736` | `videotrack_extend_navigation_course` | PHP callable `videotrack_extend_navigation_course`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `lib.php:769` | `videotrack_get_html5controls` | PHP callable `videotrack_get_html5controls`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `lib.php:785` | `videotrack_process_html5controls_field` | PHP callable `videotrack_process_html5controls_field`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `lib.php:816` | `videotrack_process_player_behavior_fields` | PHP callable `videotrack_process_player_behavior_fields`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `lib.php:853` | `videotrack_get_player_width` | PHP callable `videotrack_get_player_width`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `lib.php:868` | `videotrack_get_rewind_step` | PHP callable `videotrack_get_rewind_step`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `lib.php:889` | `videotrack_get_fastforward_step` | PHP callable `videotrack_get_fastforward_step`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `lib.php:910` | `videotrack_get_vtt_url` | PHP callable `videotrack_get_vtt_url`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `lib.php:933` | `videotrack_process_captions_fields` | PHP callable `videotrack_process_captions_fields`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `lib.php:976` | `videotrack_process_grade_fields` | PHP callable `videotrack_process_grade_fields`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `lib.php:1004` | `videotrack_grade_item_update` | PHP callable `videotrack_grade_item_update`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `lib.php:1078` | `videotrack_update_grades` | PHP callable `videotrack_update_grades`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `lib.php:1090` | `videotrack_set_user_grade` | PHP callable `videotrack_set_user_grade`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `lib.php:1107` | `videotrack_get_user_grade` | PHP callable `videotrack_get_user_grade`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `lib.php:1133` | `videotrack_get_poster_url` | PHP callable `videotrack_get_poster_url`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `lib.php:1173` | `videotrack_delete_user_progress` | PHP callable `videotrack_delete_user_progress`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `lib.php:1205` | `videotrack_grade_item_delete` | PHP callable `videotrack_grade_item_delete`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `lib.php:1226` | `videotrack_delete_instance` | PHP callable `videotrack_delete_instance`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `lib.php:1282` | `videotrack_get_coursemodule_info` | PHP callable `videotrack_get_coursemodule_info`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `lib.php:1309` | `videotrack_view` | PHP callable `videotrack_view`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `lib.php:1335` | `videotrack_get_completion_state` | Named PHP function/method `videotrack_get_completion_state`; see source DocBlock and callers for the current contract. |
| `lib.php:1373` | `videotrack_get_completion_active_rule_descriptions` | PHP callable `videotrack_get_completion_active_rule_descriptions`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `lib.php:1405` | `videotrack_update_completion_for_user` | PHP callable `videotrack_update_completion_for_user`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `lib.php:1421` | `videotrack_reset_course_userdata` | PHP callable `videotrack_reset_course_userdata`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `lib.php:1470` | `videotrack_reset_course_form_definition` | PHP callable `videotrack_reset_course_form_definition`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `lib.php:1490` | `videotrack_reset_course_form_defaults` | PHP callable `videotrack_reset_course_form_defaults`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `lib.php:1506` | `videotrack_resize_reaction_icon` | PHP callable `videotrack_resize_reaction_icon`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `lib.php:1601` | `videotrack_pluginfile` | PHP callable `videotrack_pluginfile`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `lib.php:1711` | `videotrack_recalculate_all_states` | PHP callable `videotrack_recalculate_all_states`; see its DocBlock and callers for parameter, return-value and side-effect details. |
...
| `locallib.php:444` | `videotrack_render_reaction_icon` | PHP callable `videotrack_render_reaction_icon`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `locallib.php:487` | `videotrack_get_fallback_reaction_emoji_catalog` | PHP callable `videotrack_get_fallback_reaction_emoji_catalog`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `locallib.php:521` | `videotrack_get_moodle_reaction_emoji_catalog` | PHP callable `videotrack_get_moodle_reaction_emoji_catalog`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `locallib.php:573` | `videotrack_get_reaction_icon_catalog` | PHP callable `videotrack_get_reaction_icon_catalog`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `locallib.php:619` | `videotrack_get_reaction_icon_suggestions` | PHP callable `videotrack_get_reaction_icon_suggestions`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `locallib.php:637` | `videotrack_reaction_icon_datalist` | PHP callable `videotrack_reaction_icon_datalist`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `locallib.php:664` | `videotrack_reaction_icon_picker` | PHP callable `videotrack_reaction_icon_picker`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `locallib.php:785` | `videotrack_get_all_presets` | PHP callable `videotrack_get_all_presets`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `locallib.php:799` | `videotrack_save_presets` | PHP callable `videotrack_save_presets`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `locallib.php:809` | `videotrack_get_preset_select_options` | PHP callable `videotrack_get_preset_select_options`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `locallib.php:824` | `videotrack_get_all_presets_for_js` | PHP callable `videotrack_get_all_presets_for_js`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `locallib.php:840` | `videotrack_require_preset_amd` | PHP callable `videotrack_require_preset_amd`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `locallib.php:856` | `videotrack_optional_iso_date_param` | PHP callable `videotrack_optional_iso_date_param`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `locallib.php:867` | `videotrack_get_compatible_forum_types` | PHP callable `videotrack_get_compatible_forum_types`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `locallib.php:877` | `videotrack_get_compatible_forums` | PHP callable `videotrack_get_compatible_forums`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `locallib.php:904` | `videotrack_get_compatible_forum_options` | PHP callable `videotrack_get_compatible_forum_options`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `locallib.php:931` | `videotrack_is_compatible_forum` | PHP callable `videotrack_is_compatible_forum`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `locallib.php:947` | `videotrack_build_forum_subject` | PHP callable `videotrack_build_forum_subject`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `locallib.php:976` | `videotrack_build_replay_url` | PHP callable `videotrack_build_replay_url`; see its DocBlock and callers for parameter, return-value and side-effect details. |
...
| `tests/acknowledgement_test.php:120` | `test_progress_snapshot_uses_unique_coverage` | PHP callable `test_progress_snapshot_uses_unique_coverage`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `tests/acknowledgement_test.php:138` | `test_video_end_requires_teacher_configured_duration` | PHP callable `test_video_end_requires_teacher_configured_duration`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `tests/acknowledgement_test.php:163` | `test_enabled_state_requires_nonempty_visible_text` | PHP callable `test_enabled_state_requires_nonempty_visible_text`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `tests/acknowledgement_test.php:183` | `test_analytics_summary_supports_exact_single_user_reporting` | Named PHP function/method `test_analytics_summary_supports_exact_single_user_reporting`; see source DocBlock and callers for the current contract. |
| `tests/acknowledgement_test.php:201` | `test_analytics_summary_preserves_legacy_and_privacy_rules` | PHP callable `test_analytics_summary_preserves_legacy_and_privacy_rules`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `tests/admin_settings_test.php:40` | `setUp` | PHP callable `setUp`; see its DocBlock and callers for parameter, return-value and side-effect details. |
...
| `tests/ajax_contract_test.php:298` | `test_resume_respects_server_validated_frontier` | Named PHP function/method `test_resume_respects_server_validated_frontier`; see source DocBlock and callers for the current contract. |
| `tests/ajax_contract_test.php:315` | `test_closed_segment_keeps_wallclock_start_for_ajax` | Named PHP function/method `test_closed_segment_keeps_wallclock_start_for_ajax`; see source DocBlock and callers for the current contract. |
| `tests/ajax_contract_test.php:339` | `test_seek_closes_segment_at_known_pre_seek_boundary` | Named PHP function/method `test_seek_closes_segment_at_known_pre_seek_boundary`; see source DocBlock and callers for the current contract. |
| `tests/ajax_contract_test.php:362` | `test_interactions_use_safe_time_during_blocked_seek` | Named PHP function/method `test_interactions_use_safe_time_during_blocked_seek`; see source DocBlock and callers for the current contract. |
| `tests/ajax_contract_test.php:376` | `test_reaction_runtime_contract_contains_no_raw_html_field` | PHP callable `test_reaction_runtime_contract_contains_no_raw_html_field`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `tests/ajax_contract_test.php:390` | `test_interaction_writes_use_policy_aware_timestamp_validation` | Named PHP function/method `test_interaction_writes_use_policy_aware_timestamp_validation`; see source DocBlock and callers for the current contract. |
| `tests/analytics_performance_contract_test.php:35` | `test_teacher_activity_options_use_lightweight_modinfo_path` | Named PHP function/method `test_teacher_activity_options_use_lightweight_modinfo_path`; see source DocBlock and callers for the current contract. |
| `tests/analytics_performance_contract_test.php:52` | `test_course_dashboard_batches_event_summaries_and_group_scope` | Named PHP function/method `test_course_dashboard_batches_event_summaries_and_group_scope`; see source DocBlock and callers for the current contract. |
| `tests/analytics_performance_contract_test.php:71` | `test_course_dashboard_batches_state_and_period_reads` | Named PHP function/method `test_course_dashboard_batches_state_and_period_reads`; see source DocBlock and callers for the current contract. |
...
| `tests/analytics_table_export_test.php:34` | `setUp` | PHP callable `setUp`; see its DocBlock and callers for parameter, return-value and side-effect details. |
...
| `tests/analytics_test.php:72` | `test_exact_reporting_threshold_preserves_single_user_aggregates` | Named PHP function/method `test_exact_reporting_threshold_preserves_single_user_aggregates`; see source DocBlock and callers for the current contract. |
| `tests/analytics_test.php:119` | `test_privacy_threshold_masks_small_values` | PHP callable `test_privacy_threshold_masks_small_values`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `tests/analytics_test.php:170` | `test_privacy_threshold_keeps_zero_intervals_visible` | PHP callable `test_privacy_threshold_keeps_zero_intervals_visible`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `tests/analytics_test.php:199` | `test_privacy_threshold_keeps_total_when_only_replays_are_suppressed` | PHP callable `test_privacy_threshold_keeps_total_when_only_replays_are_suppressed`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `tests/analytics_test.php:223` | `test_reaction_cluster_limit_is_reported` | PHP callable `test_reaction_cluster_limit_is_reported`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `tests/analytics_test.php:250` | `test_reaction_clusters_apply_student_threshold` | PHP callable `test_reaction_clusters_apply_student_threshold`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `tests/analytics_test.php:274` | `test_reaction_clusters_use_stable_reaction_keys` | PHP callable `test_reaction_clusters_use_stable_reaction_keys`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `tests/analytics_test.php:327` | `test_reaction_privacy_is_independent_from_viewing_privacy` | PHP callable `test_reaction_privacy_is_independent_from_viewing_privacy`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `tests/analytics_test.php:355` | `test_group_scope_restriction_uses_effective_activity_mode` | PHP callable `test_group_scope_restriction_uses_effective_activity_mode`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `tests/analytics_test.php:365` | `test_reaction_summary_masks_small_populations` | PHP callable `test_reaction_summary_masks_small_populations`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `tests/analytics_test.php:386` | `test_build_from_states_recovers_unique_viewers` | PHP callable `test_build_from_states_recovers_unique_viewers`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `tests/analytics_test.php:406` | `test_resolve_duration_uses_best_persisted_source` | PHP callable `test_resolve_duration_uses_best_persisted_source`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `tests/behat/behat_mod_videotrack.php:42` | `the_videotrack_focus_policy_is` | Asserts the effective focus policy exposed by the real player JSON. |
...
| `tests/behat/behat_mod_videotrack.php:200` | `the_deterministic_videotrack_provider_playback_is` | Asserts provider play/pause state after an asynchronous production-adapter recovery. |
| `tests/behat/behat_mod_videotrack.php:221` | `i_seek_the_deterministic_videotrack_provider_to_seconds` | Drives a deterministic provider seek through the production adapter boundary. |
| `tests/behat/behat_mod_videotrack.php:243` | `the_deterministic_videotrack_provider_time_is_between` | Requires a provider timestamp to remain inside the expected range for one polling window. |
| `tests/behat/behat_mod_videotrack.php:284` | `the_deterministic_videotrack_provider_time_matches_the_validated_frontier` | Verifies blocked provider rollback against a dynamically stable persisted validated frontier. |
| `tests/behat/behat_mod_videotrack.php:348` | `the_playback_credit_window_is_closed_by_an_accepted_pause` | Verifies that a real browser play/pause cycle uses one server-bound session and closes its credit window. |
...
| `tests/behat/behat_mod_videotrack.php:512` | `the_moodle_completion_state_for_videotrack_is` | Asserts the persisted Moodle core completion state after a VideoTrack browser interaction. |
| `tests/behat/behat_mod_videotrack.php:553` | `the_videotrack_forum_time_should_be_between` | Asserts the linked Forum composer keeps a timestamp inside the expected validated range after rollback. |
...
| `tests/csv_export_test.php:37` | `test_delimiter_options_are_scope_specific` | PHP callable `test_delimiter_options_are_scope_specific`; verifies the explicit site and activity delimiter option sets. |
| `tests/csv_export_test.php:49` | `test_delimiter_resolution` | PHP callable `test_delimiter_resolution`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `tests/csv_export_test.php:72` | `test_process_form_fields` | PHP callable `test_process_form_fields`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `tests/csv_export_test.php:89` | `test_field_options_include_video_link` | PHP callable `test_field_options_include_video_link`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `tests/csv_export_test.php:98` | `test_event_headers_match_custom_export_format` | PHP callable `test_event_headers_match_custom_export_format`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `tests/csv_export_test.php:111` | `test_identity_columns_split_lastname_and_firstname` | PHP callable `test_identity_columns_split_lastname_and_firstname`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `tests/csv_export_test.php:126` | `test_cluster_notes_concatenates_comments_and_counts_students` | PHP callable `test_cluster_notes_concatenates_comments_and_counts_students`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `tests/csv_export_test.php:148` | `test_safe_value_blocks_formula_injection` | PHP callable `test_safe_value_blocks_formula_injection`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `tests/csv_export_test.php:158` | `test_write_utf8_bom` | PHP callable `test_write_utf8_bom`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `tests/csv_export_test.php:170` | `test_write_row_supports_section_sign_delimiter` | PHP callable `test_write_row_supports_section_sign_delimiter`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `tests/focus_policy_test.php:37` | `test_exception_group_is_idempotent_hidden_and_non_participating` | Verifies stable hidden/non-participating group creation. |
| `tests/focus_policy_test.php:58` | `test_member_receives_hidden_only_policy_when_site_is_strict` | Verifies the strict-focus exception for an authorised member. |
| `tests/focus_policy_test.php:83` | `test_non_member_keeps_strict_policy` | Verifies strict policy remains effective outside the exception group. |
| `tests/focus_policy_test.php:104` | `test_hidden_only_site_policy_is_unchanged` | Verifies the exception never weakens the normal hidden-only policy. |
| `tests/focus_policy_test.php:123` | `test_activity_lifecycle_and_view_are_wired_to_focus_policy` | Verifies add, update, restore and view integration contracts. |
...
| `tests/generator_test.php:118` | `test_generator_creates_vimeo_provider_fixture` | Verifies the reserved deterministic Vimeo fixture identifier and duration. |
| `tests/generator_test.php:138` | `test_generator_links_named_forum_fixture` | Verifies the generator resolves a named same-course Forum for deterministic browser fixtures. |
...
| `tests/gradebook_restore_contract_test.php:113` | `test_gradebook_repair_removes_missing_course_module_context` | Verifies that upgrade-safe repair removes a grade item whose activity no longer has a course-module context. |
| `tests/gradebook_restore_contract_test.php:162` | `test_uninstall_hook_cleans_valid_and_orphan_grade_items_first` | Verifies Grade API cleanup for valid contexts and DML fallback for existing orphan rows before core module removal. |
...
| `tests/integrity_test.php:73` | `test_random_pause_bounds_are_configurable_and_normalised` | PHP callable `test_random_pause_bounds_are_configurable_and_normalised`; see its DocBlock and callers for parameter, return-value and side-effect details. |
...
| `tests/lib_test.php:41` | `setUp` | PHP callable `setUp`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `tests/lib_test.php:49` | `test_supports_expected_core_features` | PHP callable `test_supports_expected_core_features`; see its DocBlock and callers for parameter, return-value and side-effect details. |
...
| `tests/lib_test.php:69` | `test_activity_chooser_metadata_is_reported` | PHP callable `test_activity_chooser_metadata_is_reported`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `tests/lib_test.php:77` | `test_unknown_feature_returns_null` | PHP callable `test_unknown_feature_returns_null`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `tests/lib_test.php:84` | `test_player_behavior_fields_normalise_bookmark_setting` | PHP callable `test_player_behavior_fields_normalise_bookmark_setting`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `tests/lib_test.php:110` | `test_caption_normalisation_preserves_provider_timed_text_settings` | PHP callable `test_caption_normalisation_preserves_provider_timed_text_settings`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `tests/locallib_test.php:49` | `setUp` | PHP callable `setUp`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `tests/locallib_test.php:57` | `test_extract_videoid_accepts_supported_youtube_urls` | PHP callable `test_extract_videoid_accepts_supported_youtube_urls`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `tests/locallib_test.php:72` | `test_extract_vimeo_id_accepts_supported_vimeo_urls` | PHP callable `test_extract_vimeo_id_accepts_supported_vimeo_urls`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `tests/locallib_test.php:86` | `test_format_seconds_clamps_and_formats_duration` | PHP callable `test_format_seconds_clamps_and_formats_duration`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `tests/locallib_test.php:96` | `test_format_video_timestamp_uses_total_duration` | PHP callable `test_format_video_timestamp_uses_total_duration`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `tests/locallib_test.php:105` | `test_parse_video_timestamp_accepts_supported_formats` | PHP callable `test_parse_video_timestamp_accepts_supported_formats`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `tests/locallib_test.php:118` | `test_parse_report_timestamp_requires_colon_format` | PHP callable `test_parse_report_timestamp_requires_colon_format`; see its DocBlock and callers for parameter, return-value and side-effect details. |
...
| `tests/locallib_test.php:145` | `test_get_config_int_rejects_invalid_bounds` | PHP callable `test_get_config_int_rejects_invalid_bounds`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `tests/locallib_test.php:153` | `test_get_playback_speeds_filters_and_applies_site_cap` | PHP callable `test_get_playback_speeds_filters_and_applies_site_cap`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `tests/locallib_test.php:172` | `test_tracking_playback_speeds_include_blocked_seek_penalty_only_when_needed` | Named PHP function/method `test_tracking_playback_speeds_include_blocked_seek_penalty_only_when_needed`; see source DocBlock and callers for the current contract. |
| `tests/locallib_test.php:197` | `test_compatible_forum_types_exclude_single_use_forums` | PHP callable `test_compatible_forum_types_exclude_single_use_forums`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `tests/locallib_test.php:204` | `test_build_replay_url_applies_window_and_duration` | PHP callable `test_build_replay_url_applies_window_and_duration`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `tests/locallib_test.php:218` | `test_build_forum_subject_replaces_supported_placeholders` | PHP callable `test_build_forum_subject_replaces_supported_placeholders`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `tests/locallib_test.php:232` | `test_build_forum_subject_uses_default_template` | PHP callable `test_build_forum_subject_uses_default_template`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `tests/locallib_test.php:243` | `test_render_reaction_icon_includes_visible_label` | Verifies that reaction icons always include their visible accessible label. |
...
| `tests/release_hygiene_contract_test.php:35` | `test_csv_export_format_strings_have_explicit_context` | Named PHP function/method `test_csv_export_format_strings_have_explicit_context`; see source DocBlock and callers for the current contract. |
...
| `tests/report_contract_test.php:132` | `test_report_confirmation_uses_supported_modal_api` | PHP callable `test_report_confirmation_uses_supported_modal_api`; static regression contract for the teacher report controller. |
| `tests/report_contract_test.php:145` | `test_custom_csv_event_rows_delegate_to_writer` | PHP callable `test_custom_csv_event_rows_delegate_to_writer`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `tests/report_contract_test.php:157` | `test_custom_csv_export_supports_private_bookmark_counts` | PHP callable `test_custom_csv_export_supports_private_bookmark_counts`; static regression contract for the teacher report controller. |
| `tests/report_contract_test.php:173` | `test_custom_csv_event_writer_receives_module_context` | PHP callable `test_custom_csv_event_writer_receives_module_context`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `tests/report_contract_test.php:189` | `test_student_grade_visibility_depends_on_participation_not_report_access` | PHP callable `test_student_grade_visibility_depends_on_participation_not_report_access`; static regression contract for the teacher report controller. |
| `tests/report_contract_test.php:207` | `test_student_grade_label_uses_plugin_string` | PHP callable `test_student_grade_label_uses_plugin_string`; static regression contract for the teacher report controller. |
| `tests/report_contract_test.php:217` | `test_provider_and_integrity_notices_share_one_alert` | PHP callable `test_provider_and_integrity_notices_share_one_alert`; static regression contract for the teacher report controller. |
| `tests/report_contract_test.php:234` | `test_report_support_helpers_are_extracted_from_controller` | PHP callable `test_report_support_helpers_are_extracted_from_controller`; static regression contract for the teacher report controller. |
| `tests/report_contract_test.php:313` | `test_analytics_rendering_is_extracted_from_report_controller` | PHP callable `test_analytics_rendering_is_extracted_from_report_controller`; static regression contract for the teacher report controller. |
| `tests/report_support_test.php:37` | `test_date_to_timestamp_rejects_invalid_values` | PHP callable `test_date_to_timestamp_rejects_invalid_values`; behavioural coverage for extracted report request/filter/scope helpers. |
| `tests/report_support_test.php:55` | `test_duration_filter_preserves_structured_controls` | PHP callable `test_duration_filter_preserves_structured_controls`; behavioural coverage for extracted report request/filter/scope helpers. |
| `tests/report_support_test.php:69` | `test_user_label_respects_email_visibility` | PHP callable `test_user_label_respects_email_visibility`; behavioural coverage for extracted report request/filter/scope helpers. |
| `tests/report_support_test.php:89` | `test_tabs_preserve_capability_dependent_set` | PHP callable `test_tabs_preserve_capability_dependent_set`; behavioural coverage for extracted report request/filter/scope helpers. |
| `tests/report_support_test.php:105` | `test_empty_scope_conditions_remain_deny_all` | PHP callable `test_empty_scope_conditions_remain_deny_all`; behavioural coverage for extracted report request/filter/scope helpers. |
| `tests/report_support_test.php:118` | `test_analytics_prefers_state_fallback_preserves_selection_rules` | PHP callable `test_analytics_prefers_state_fallback_preserves_selection_rules`; behavioural coverage for viewer priority and strict epsilon handling in state-fallback selection. |
| `tests/report_support_test.php:143` | `test_analytics_highlights_preserve_report_semantics` | PHP callable `test_analytics_highlights_preserve_report_semantics`; behavioural coverage for extracted Analytics highlight filtering, ordering, discontinuity and top-five truncation. |
| `tests/report_support_test.php:175` | `test_analytics_acknowledgement_timing_counts_preserve_policy_buckets` | PHP callable `test_analytics_acknowledgement_timing_counts_preserve_policy_buckets`; behavioural coverage for extracted acknowledgement timing-bucket counting. |
| `tests/report_support_test.php:195` | `test_analytics_reaction_condition_preserves_scope_and_provider_filter` | PHP callable `test_analytics_reaction_condition_preserves_scope_and_provider_filter`; behavioural coverage for extracted reaction-Analytics scope/event/provider filtering. |
| `tests/report_support_test.php:230` | `test_analytics_bookmark_condition_preserves_scope_and_provider_filter` | PHP callable `test_analytics_bookmark_condition_preserves_scope_and_provider_filter`; behavioural coverage for extracted bookmark-Analytics scope/event/provider filtering. |
| `tests/report_support_test.php:264` | `test_analytics_integrity_condition_preserves_scope_and_provider_filter` | PHP callable `test_analytics_integrity_condition_preserves_scope_and_provider_filter`; behavioural coverage for extracted integrity-Analytics scope/provider filtering. |
| `tests/report_support_test.php:294` | `test_analytics_state_condition_preserves_scope_and_provider_filter` | PHP callable `test_analytics_state_condition_preserves_scope_and_provider_filter`; behavioural coverage that locks whole-scope parenthesisation for state-Analytics provider filtering. |
| `tests/report_support_test.php:324` | `test_analytics_segment_condition_preserves_scope_and_provider_filter` | PHP callable `test_analytics_segment_condition_preserves_scope_and_provider_filter`; behavioural coverage for extracted validated-segment Analytics scope/provider filtering. |
| `tests/report_support_test.php:357` | `test_reaction_event_condition_preserves_filters_and_scope` | PHP callable `test_reaction_event_condition_preserves_filters_and_scope`; behavioural coverage for extracted standard reaction-event SQL/parameter construction. |
| `tests/report_support_test.php:405` | `test_bookmark_event_condition_preserves_filters_and_scope` | PHP callable `test_bookmark_event_condition_preserves_filters_and_scope`; behavioural coverage for extracted standard bookmark-event SQL/parameter construction. |
| `tests/report_support_test.php:449` | `test_integrity_event_condition_preserves_filters_and_scope` | PHP callable `test_integrity_event_condition_preserves_filters_and_scope`; behavioural coverage for extracted standard integrity-event SQL/parameter construction. |
| `tests/report_support_test.php:492` | `test_note_user_condition_preserves_scope_and_optional_user` | PHP callable `test_note_user_condition_preserves_scope_and_optional_user`; behavioural coverage for extracted personal-note user-discovery SQL/parameter construction. |
| `tests/report_support_test.php:528` | `test_note_event_condition_preserves_scope_user_and_creation_bounds` | PHP callable `test_note_event_condition_preserves_scope_user_and_creation_bounds`; behavioural coverage for extracted per-student personal-note SQL/parameter construction. |
| `tests/report_support_test.php:571` | `test_state_condition_preserves_scope_and_optional_user` | PHP callable `test_state_condition_preserves_scope_and_optional_user`; behavioural coverage for extracted state-row SQL/parameter construction. |
| `tests/report_support_test.php:603` | `test_segment_user_condition_preserves_scope` | PHP callable `test_segment_user_condition_preserves_scope`; behavioural coverage for extracted segment-user discovery SQL/parameter construction. |
| `tests/report_support_test.php:632` | `test_user_options_preserve_source_priority_and_privacy` | PHP callable `test_user_options_preserve_source_priority_and_privacy`; behavioural coverage for extracted report-user option assembly. |
| `tests/report_support_test.php:664` | `test_cluster_reaction_events_preserves_report_semantics` | PHP callable `test_cluster_reaction_events_preserves_report_semantics`; behavioural coverage for extracted reaction clustering. |
...
| `tests/tracker_test.php:76` | `test_merge_intervals_and_covered_seconds_are_deterministic` | PHP callable `test_merge_intervals_and_covered_seconds_are_deterministic`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `tests/tracker_test.php:91` | `test_simplify_intervals_never_overestimates_coverage` | PHP callable `test_simplify_intervals_never_overestimates_coverage`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `tests/tracker_test.php:108` | `test_aggregate_segments_rebuilds_state_values` | PHP callable `test_aggregate_segments_rebuilds_state_values`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `tests/tracker_test.php:146` | `test_start_boundary_normalisation_recovers_only_tiny_initial_gap` | PHP callable `test_start_boundary_normalisation_recovers_only_tiny_initial_gap`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `tests/tracker_test.php:160` | `test_natural_end_normalisation_is_bounded_and_reason_specific` | PHP callable `test_natural_end_normalisation_is_bounded_and_reason_specific`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `tests/tracker_test.php:178` | `test_aggregate_segments_recovers_full_watch_boundary_drift` | PHP callable `test_aggregate_segments_recovers_full_watch_boundary_drift`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `tests/tracker_test.php:216` | `test_update_state_recovers_boundary_drift_but_preserves_raw_segment` | PHP callable `test_update_state_recovers_boundary_drift_but_preserves_raw_segment`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `tests/tracker_test.php:275` | `test_rebuild_state_recovers_provider_boundary_drift` | PHP callable `test_rebuild_state_recovers_provider_boundary_drift`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `tests/tracker_test.php:320` | `test_cap_intervals_limits_count_and_preserves_order` | PHP callable `test_cap_intervals_limits_count_and_preserves_order`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `tests/tracker_test.php:339` | `test_aggregate_segments_keeps_exact_coverage_after_interval_cap` | PHP callable `test_aggregate_segments_keeps_exact_coverage_after_interval_cap`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `tests/tracker_test.php:359` | `test_server_credit_budget_requires_elapsed_server_time` | PHP callable `test_server_credit_budget_requires_elapsed_server_time`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `tests/tracker_test.php:391` | `test_server_credit_tolerance_is_cumulative_and_not_reusable` | PHP callable `test_server_credit_tolerance_is_cumulative_and_not_reusable`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `tests/tracker_test.php:414` | `test_server_credit_budget_scales_only_with_validated_rate` | PHP callable `test_server_credit_budget_scales_only_with_validated_rate`; see its DocBlock and callers for parameter, return-value and side-effect details. |
...
| `tests/upgrade_contract_test.php:84` | `test_failed_install_schema_recovery_supersedes_obsolete_lineage` | Named PHP function/method `test_failed_install_schema_recovery_supersedes_obsolete_lineage`; see source DocBlock and callers for the current contract. |
| `tests/upgrade_contract_test.php:114` | `test_gradebook_recovery_uses_dml_only` | Named PHP function/method `test_gradebook_recovery_uses_dml_only`; see source DocBlock and callers for the current contract. |
| `tests/upgrade_contract_test.php:136` | `test_preproduction_gradebook_repair_covers_install_and_upgrade` | Named PHP function/method `test_preproduction_gradebook_repair_covers_install_and_upgrade`; see source DocBlock and callers for the current contract. |
| `tests/upgrade_contract_test.php:160` | `test_duplicate_grade_item_repair_is_upgrade_safe` | Named PHP function/method `test_duplicate_grade_item_repair_is_upgrade_safe`; see source DocBlock and callers for the current contract. |

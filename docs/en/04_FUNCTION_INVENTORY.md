...
Generated from the VideoTrack 1.7.59 source tree. PHP entries include named functions and methods; AMD entries include named declarations, assigned function expressions and object-method functions.
...
| `classes/local/analytics.php:48` | `resolve_duration` | PHP callable `resolve_duration`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/local/analytics.php:66` | `default_bin_size` | PHP callable `default_bin_size`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/local/analytics.php:93` | `restrict_to_own_groups` | PHP callable `restrict_to_own_groups`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/local/analytics.php:104` | `normalise_bin_size` | PHP callable `normalise_bin_size`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/local/analytics.php:132` | `build` | PHP callable `build`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/local/analytics.php:235` | `build_from_states` | PHP callable `build_from_states`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/local/analytics.php:273` | `apply_privacy_threshold` | PHP callable `apply_privacy_threshold`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/local/analytics.php:333` | `count_summary` | PHP callable `count_summary`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/local/analytics.php:356` | `reaction_summary` | PHP callable `reaction_summary`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/local/analytics.php:368` | `cluster_reactions` | PHP callable `cluster_reactions`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/local/analytics.php:429` | `append_visible_reaction_cluster` | PHP callable `append_visible_reaction_cluster`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/local/analytics.php:458` | `add_user_intervals` | PHP callable `add_user_intervals`; see its DocBlock and callers for parameter, return-value and side-effect details. |
...
| `classes/local/report_view.php:248` | `privacy_alert` | PHP callable `report_view::privacy_alert`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/local/report_view.php:275` | `heatmap_legend` | PHP callable `report_view::heatmap_legend`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/local/report_view.php:320` | `analytics_download` | PHP callable `report_view::analytics_download`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/local/report_view.php:377` | `reaction_clusters` | PHP callable `report_view::reaction_clusters`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/local/report_view.php:412` | `reaction_summary` | PHP callable `report_view::reaction_summary`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/local/report_view.php:435` | `bookmark_summary` | PHP callable `report_view::bookmark_summary`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/local/report_view.php:501` | `acknowledgement_summary` | PHP callable `report_view::acknowledgement_summary`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/local/report_view.php:610` | `integrity_summary` | PHP callable `report_view::integrity_summary`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `classes/local/report_view.php:701` | `analytics_retention` | PHP callable `report_view::analytics_retention`; see its DocBlock and callers for parameter, return-value and side-effect details. |
...
| `report.php:128` | `videotrack_report_duration_filter` | PHP callable `videotrack_report_duration_filter`; see its DocBlock and callers for parameter, return-value and side-effect details. |
...
| `tests/acknowledgement_test.php:183` | `test_analytics_summary_preserves_legacy_and_privacy_rules` | PHP callable `test_analytics_summary_preserves_legacy_and_privacy_rules`; see its DocBlock and callers for parameter, return-value and side-effect details. |
...
| `tests/analytics_test.php:123` | `test_privacy_threshold_keeps_zero_intervals_visible` | PHP callable `test_privacy_threshold_keeps_zero_intervals_visible`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `tests/analytics_test.php:152` | `test_privacy_threshold_keeps_total_when_only_replays_are_suppressed` | PHP callable `test_privacy_threshold_keeps_total_when_only_replays_are_suppressed`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `tests/analytics_test.php:176` | `test_reaction_cluster_limit_is_reported` | PHP callable `test_reaction_cluster_limit_is_reported`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `tests/analytics_test.php:203` | `test_reaction_clusters_apply_student_threshold` | PHP callable `test_reaction_clusters_apply_student_threshold`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `tests/analytics_test.php:227` | `test_reaction_clusters_use_stable_reaction_keys` | PHP callable `test_reaction_clusters_use_stable_reaction_keys`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `tests/analytics_test.php:280` | `test_reaction_privacy_is_independent_from_viewing_privacy` | PHP callable `test_reaction_privacy_is_independent_from_viewing_privacy`; see its DocBlock and callers for parameter, return-value and side-effect details. |
| `tests/analytics_test.php:308` | `test_group_scope_restriction_uses_effective_activity_mode` | PHP callable `test_group_scope_restriction_uses_effective_activity_mode`; see its DocBlock and callers for parameter, return-value and side-effect details. |

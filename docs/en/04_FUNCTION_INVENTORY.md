...
| `classes/external/helper.php:123` | `mod_videotrack\external\helper::load_and_validate_context` | Loads the activity and validates login, context, view and explicit participation capability. |

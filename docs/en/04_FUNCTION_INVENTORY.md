...
Generated from the VideoTrack 1.7.105 source tree. PHP entries include named functions and methods; AMD entries include named declarations, assigned function expressions and object-method functions.
...
| `tests/behat/behat_mod_videotrack.php:314` | `the_latest_seek_segment_matches_the_pre_seek_browser_time` | Verifies the raw pre-seek endpoint and rejects any aggregate credit or resume position inside the skipped gap. |

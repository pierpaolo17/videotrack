...
| Media input helpers | `locallib.php`, `docs/en/15_MEDIA_PROVIDERS_DURATION.md` | HTTPS URL normalisation, provider identifier extraction, timestamp parsing and shared presentation helpers. |

...
- Documentation markers, root README files and ER artefacts identify 1.7.116 / 2026082800.
- The activity icon is `pix/icon.png`; the former SVG is not distributed.

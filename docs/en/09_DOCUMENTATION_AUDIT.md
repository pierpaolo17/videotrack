...
- Documentation markers, root README files and ER artefacts identify 1.7.127 / 2026091002.
...
- PHPStan/Psalm have versioned production-only scopes and a shared installed-Moodle bootstrap. The bootstrap loads
  the canonical backup/restore include graphs before the Moodle 2 step libraries, Psalm's documented finding exit
  is advisory, and PHPStan internal/incomplete reports remain blocking. Fresh Moodle 5.0 and 5.3 runs are required
  for the first valid remediation baselines.

...
- Documentation markers, root README files and ER artefacts identify 1.7.132 / 2026091202.
...
- The ten production files that consume globals or containers supplied by Moodle loaders carry narrow `@var`
  declarations. They document the existing contract without assigning values or suppressing unrelated findings.

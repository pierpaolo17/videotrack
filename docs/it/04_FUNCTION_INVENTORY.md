...
Generato dall’albero sorgente VideoTrack 1.7.73. Le voci PHP includono funzioni e metodi nominati; le voci AMD includono dichiarazioni nominate, espressioni funzione assegnate e funzioni-metodo di oggetti.

**Funzioni/metodi PHP:** 675. **Callable AMD nominati:** 647.
...
| `classes/local/report_support.php:413` | `user_options` | Callable PHP `report_support::user_options`; costruzione delle opzioni utente del report in ordine di priorità con label rispettose della privacy. |
| `classes/local/report_support.php:445` | `cluster_reaction_events` | Callable PHP `report_support::cluster_reaction_events`; clustering limitato delle reazioni con semantica invariata per finestra, conteggio studenti e ordinamento. |
| `classes/local/report_support.php:520` | `tabs` | Callable PHP `report_support::tabs`; costruzione dei tab report dipendente dalle capability. |
...
| `tests/report_contract_test.php:206` | `test_analytics_rendering_is_extracted_from_report_controller` | Callable PHP `test_analytics_rendering_is_extracted_from_report_controller`; contratto statico di regressione per il controller del report docente. |
...
| `tests/report_support_test.php:207` | `test_user_options_preserve_source_priority_and_privacy` | Callable PHP `test_user_options_preserve_source_priority_and_privacy`; copertura comportamentale della costruzione estratta delle opzioni utente. |
| `tests/report_support_test.php:239` | `test_cluster_reaction_events_preserves_report_semantics` | Callable PHP `test_cluster_reaction_events_preserves_report_semantics`; copertura comportamentale del clustering reazioni estratto. |

...
Generato dall’albero sorgente VideoTrack 1.7.103. Le voci PHP includono funzioni e metodi nominati; le voci AMD includono dichiarazioni nominate, espressioni funzione assegnate e funzioni-metodo di oggetti.

**Funzioni/metodi PHP:** 735. **Callable AMD nominati:** 647.
...
| `tests/behat/behat_mod_videotrack.php:314` | `the_latest_seek_segment_matches_the_pre_seek_browser_time` | Attende la write seek reale e verifica che il suo estremo validato coincida con il timestamp browser acquisito prima del salto. |

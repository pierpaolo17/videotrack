...
Generato dall’albero sorgente VideoTrack 1.7.85. Le voci PHP includono funzioni e metodi nominati; le voci AMD includono dichiarazioni nominate, espressioni funzione assegnate e funzioni-metodo di oggetti.
...
| `classes/local/report_support.php:313` | `acknowledgement_scope_condition` | Callable PHP `report_support::acknowledgement_scope_condition`; costruzione SQL dello scope presa visione sulla versione corrente. |
| `classes/local/report_support.php:387` | `reaction_event_condition` | Callable PHP `report_support::reaction_event_condition`; costruzione SQL/parametri degli eventi di reazione standard con scope learner e filtri report opzionali. |
| `classes/local/report_support.php:429` | `bookmark_event_condition` | Callable PHP `report_support::bookmark_event_condition`; costruzione SQL/parametri degli eventi bookmark standard con scope learner e filtri report opzionali. |
| `classes/local/report_support.php:465` | `integrity_event_condition` | Callable PHP `report_support::integrity_event_condition`; costruzione SQL/parametri degli eventi integrity standard con scope learner e filtri report opzionali. |
| `classes/local/report_support.php:502` | `note_user_condition` | Callable PHP `report_support::note_user_condition`; costruzione SQL/parametri per individuare gli utenti con note personali, con scope learner e filtro studente opzionale. |
| `classes/local/report_support.php:530` | `note_event_condition` | Callable PHP `report_support::note_event_condition`; costruzione SQL/parametri delle note personali per-studente con scope learner, filtro studente opzionale e limiti inclusivi sul tempo di creazione. |
| `classes/local/report_support.php:564` | `state_condition` | Callable PHP `report_support::state_condition`; costruzione SQL/parametri delle righe di stato con scope learner e filtro studente opzionale. |
| `classes/local/report_support.php:590` | `segment_user_condition` | Callable PHP `report_support::segment_user_condition`; costruzione SQL/parametri per individuare gli utenti rappresentati nei segmenti con scope learner canonico. |
| `classes/local/report_support.php:609` | `user_options` | Callable PHP `report_support::user_options`; costruzione delle opzioni utente del report in ordine di priorità con label rispettose della privacy. |
| `classes/local/report_support.php:641` | `cluster_reaction_events` | Callable PHP `report_support::cluster_reaction_events`; clustering limitato delle reazioni con semantica invariata per finestra, conteggio studenti e ordinamento. |
| `classes/local/report_support.php:719` | `tabs` | Callable PHP `report_support::tabs`; costruzione dei tab report dipendente dalle capability. |
...
| `tests/report_contract_test.php:287` | `test_analytics_rendering_is_extracted_from_report_controller` | Callable PHP `test_analytics_rendering_is_extracted_from_report_controller`; contratto statico di regressione per il controller del report docente. |
...
| `tests/report_support_test.php:185` | `test_reaction_event_condition_preserves_filters_and_scope` | Callable PHP `test_reaction_event_condition_preserves_filters_and_scope`; copertura comportamentale della costruzione SQL/parametri estratta per gli eventi di reazione standard. |
| `tests/report_support_test.php:233` | `test_bookmark_event_condition_preserves_filters_and_scope` | Callable PHP `test_bookmark_event_condition_preserves_filters_and_scope`; copertura comportamentale della costruzione SQL/parametri estratta per gli eventi bookmark standard. |
| `tests/report_support_test.php:277` | `test_integrity_event_condition_preserves_filters_and_scope` | Callable PHP `test_integrity_event_condition_preserves_filters_and_scope`; copertura comportamentale della costruzione SQL/parametri estratta per gli eventi integrity standard. |
| `tests/report_support_test.php:320` | `test_note_user_condition_preserves_scope_and_optional_user` | Callable PHP `test_note_user_condition_preserves_scope_and_optional_user`; copertura comportamentale della costruzione SQL/parametri estratta per individuare gli utenti con note personali. |
| `tests/report_support_test.php:356` | `test_note_event_condition_preserves_scope_user_and_creation_bounds` | Callable PHP `test_note_event_condition_preserves_scope_user_and_creation_bounds`; copertura comportamentale della costruzione SQL/parametri estratta per le note personali per-studente. |
| `tests/report_support_test.php:399` | `test_state_condition_preserves_scope_and_optional_user` | Callable PHP `test_state_condition_preserves_scope_and_optional_user`; copertura comportamentale della costruzione SQL/parametri delle righe di stato estratta. |
| `tests/report_support_test.php:431` | `test_segment_user_condition_preserves_scope` | Callable PHP `test_segment_user_condition_preserves_scope`; copertura comportamentale della costruzione SQL/parametri estratta per individuare gli utenti rappresentati nei segmenti. |
| `tests/report_support_test.php:460` | `test_user_options_preserve_source_priority_and_privacy` | Callable PHP `test_user_options_preserve_source_priority_and_privacy`; copertura comportamentale della costruzione estratta delle opzioni utente. |
| `tests/report_support_test.php:492` | `test_cluster_reaction_events_preserves_report_semantics` | Callable PHP `test_cluster_reaction_events_preserves_report_semantics`; copertura comportamentale del clustering reazioni estratto. |

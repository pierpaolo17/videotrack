...
Generato dall’albero sorgente VideoTrack 1.7.84. Le voci PHP includono funzioni e metodi nominati; le voci AMD includono dichiarazioni nominate, espressioni funzione assegnate e funzioni-metodo di oggetti.
...
| `tests/cli_contract_test.php:55` | `test_course_analytics_benchmark_uses_real_read_only_metrics` | Funzione/metodo PHP nominato `test_course_analytics_benchmark_uses_real_read_only_metrics`; vedere DocBlock e chiamanti per il contratto corrente. |
| `tests/cli_contract_test.php:77` | `test_cli_tools_are_documented_for_admins_and_maintainers` | Funzione/metodo PHP nominato `test_cli_tools_are_documented_for_admins_and_maintainers`; vedere DocBlock e chiamanti per il contratto corrente. |
| `tests/completion_contract_test.php:35` | `test_required_reactions_activate_custom_completion` | Funzione/metodo PHP nominato `test_required_reactions_activate_custom_completion`; vedere DocBlock e chiamanti per il contratto corrente. |
| `tests/completion_contract_test.php:55` | `test_required_reaction_or_semantics_match_tracker` | Funzione/metodo PHP nominato `test_required_reaction_or_semantics_match_tracker`; vedere DocBlock e chiamanti per il contratto corrente. |
| `tests/completion_contract_test.php:76` | `test_disabled_acknowledgement_is_excluded_from_tracker_completion` | Funzione/metodo PHP nominato `test_disabled_acknowledgement_is_excluded_from_tracker_completion`; vedere DocBlock e chiamanti per il contratto corrente. |
| `tests/completion_contract_test.php:101` | `test_disabled_reactions_are_excluded_from_tracker_completion` | Funzione/metodo PHP nominato `test_disabled_reactions_are_excluded_from_tracker_completion`; vedere DocBlock e chiamanti per il contratto corrente. |
| `tests/completion_contract_test.php:121` | `test_moodle_completion_uses_composite_rule_contract` | Funzione/metodo PHP nominato `test_moodle_completion_uses_composite_rule_contract`; vedere DocBlock e chiamanti per il contratto corrente. |
| `tests/completion_contract_test.php:137` | `test_form_includes_required_reactions_in_completion_contract` | Funzione/metodo PHP nominato `test_form_includes_required_reactions_in_completion_contract`; vedere DocBlock e chiamanti per il contratto corrente. |
| `tests/completion_contract_test.php:157` | `test_instance_update_recalculates_changed_completion_configuration` | Funzione/metodo PHP nominato `test_instance_update_recalculates_changed_completion_configuration`; vedere DocBlock e chiamanti per il contratto corrente. |
| `tests/completion_contract_test.php:184` | `test_acknowledgement_policy_changes_completion_signature_behaviorally` | Funzione/metodo PHP nominato `test_acknowledgement_policy_changes_completion_signature_behaviorally`; vedere DocBlock e chiamanti per il contratto corrente. |
| `tests/completion_contract_test.php:219` | `test_empty_acknowledgement_is_not_a_custom_rule` | Funzione/metodo PHP nominato `test_empty_acknowledgement_is_not_a_custom_rule`; vedere DocBlock e chiamanti per il contratto corrente. |
| `tests/completion_contract_test.php:238` | `test_completion_adapters_preserve_userid_without_state_row` | Funzione/metodo PHP nominato `test_completion_adapters_preserve_userid_without_state_row`; vedere DocBlock e chiamanti per il contratto corrente. |
...
| `tests/generator_test.php:96` | `test_generator_links_named_forum_fixture` | Verifica che il generator risolva per nome un Forum dello stesso corso per fixture browser deterministiche. |
...
| `tests/lib_test.php:71` | `test_activity_chooser_metadata_is_reported` | Callable PHP `test_activity_chooser_metadata_is_reported`; DocBlock e chiamanti definiscono parametri, valori restituiti ed effetti. |
| `tests/lib_test.php:81` | `test_unknown_feature_returns_null` | Callable PHP `test_unknown_feature_returns_null`; DocBlock e chiamanti definiscono parametri, valori restituiti ed effetti. |
| `tests/lib_test.php:90` | `test_player_behavior_fields_normalise_bookmark_setting` | Callable PHP `test_player_behavior_fields_normalise_bookmark_setting`; DocBlock e chiamanti definiscono parametri, valori restituiti ed effetti. |
| `tests/lib_test.php:118` | `test_caption_normalisation_preserves_provider_timed_text_settings` | Callable PHP `test_caption_normalisation_preserves_provider_timed_text_settings`; DocBlock e chiamanti definiscono parametri, valori restituiti ed effetti. |
| `tests/locallib_test.php:35` | `setUp` | Callable PHP `setUp`; DocBlock e chiamanti definiscono parametri, valori restituiti ed effetti. |
| `tests/locallib_test.php:45` | `test_extract_videoid_accepts_supported_youtube_urls` | Callable PHP `test_extract_videoid_accepts_supported_youtube_urls`; DocBlock e chiamanti definiscono parametri, valori restituiti ed effetti. |
| `tests/locallib_test.php:62` | `test_extract_vimeo_id_accepts_supported_vimeo_urls` | Callable PHP `test_extract_vimeo_id_accepts_supported_vimeo_urls`; DocBlock e chiamanti definiscono parametri, valori restituiti ed effetti. |
| `tests/locallib_test.php:78` | `test_format_seconds_clamps_and_formats_duration` | Callable PHP `test_format_seconds_clamps_and_formats_duration`; DocBlock e chiamanti definiscono parametri, valori restituiti ed effetti. |
| `tests/locallib_test.php:90` | `test_format_video_timestamp_uses_total_duration` | Callable PHP `test_format_video_timestamp_uses_total_duration`; DocBlock e chiamanti definiscono parametri, valori restituiti ed effetti. |
| `tests/locallib_test.php:101` | `test_parse_video_timestamp_accepts_supported_formats` | Callable PHP `test_parse_video_timestamp_accepts_supported_formats`; DocBlock e chiamanti definiscono parametri, valori restituiti ed effetti. |
| `tests/locallib_test.php:116` | `test_parse_report_timestamp_requires_colon_format` | Callable PHP `test_parse_report_timestamp_requires_colon_format`; DocBlock e chiamanti definiscono parametri, valori restituiti ed effetti. |
...
| `tests/release_hygiene_contract_test.php:190` | `test_privacy_summaries_keep_parallel_section_structure` | Funzione/metodo PHP nominato `test_privacy_summaries_keep_parallel_section_structure`; vedere DocBlock e chiamanti per il contratto corrente. |

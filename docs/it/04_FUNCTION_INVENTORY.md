...
| `tests/acknowledgement_test.php:58` | `test_video_end_requirement_uses_persisted_intervals` | Callable PHP `test_video_end_requirement_uses_persisted_intervals`; DocBlock e chiamanti definiscono parametri, valori restituiti ed effetti. |
| `tests/acknowledgement_test.php:83` | `test_progress_snapshot_uses_unique_coverage` | Callable PHP `test_progress_snapshot_uses_unique_coverage`; DocBlock e chiamanti definiscono parametri, valori restituiti ed effetti. |
| `tests/acknowledgement_test.php:101` | `test_video_end_requires_teacher_configured_duration` | Callable PHP `test_video_end_requires_teacher_configured_duration`; DocBlock e chiamanti definiscono parametri, valori restituiti ed effetti. |
| `tests/acknowledgement_test.php:126` | `test_enabled_state_requires_nonempty_visible_text` | Callable PHP `test_enabled_state_requires_nonempty_visible_text`; DocBlock e chiamanti definiscono parametri, valori restituiti ed effetti. |
| `tests/acknowledgement_test.php:146` | `test_analytics_summary_preserves_legacy_and_privacy_rules` | Callable PHP `test_analytics_summary_preserves_legacy_and_privacy_rules`; DocBlock e chiamanti definiscono parametri, valori restituiti ed effetti. |

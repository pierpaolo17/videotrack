...
| `serverplaybacksessionid` | `char`(64) | NOT NULL; nessun default di schema | Sessione browser autorizzata a consumare il credito server; il runtime scrive esplicitamente il valore vuoto inattivo |

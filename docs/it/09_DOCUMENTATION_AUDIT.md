...
Baseline: VideoTrack **1.7.127** (`2026091002`).
...
- Marker documentali, README principali e artefatti ER identificano 1.7.127 / 2026091002.
...
- PHPStan/Psalm hanno perimetri versionati limitati alla produzione e un bootstrap Moodle installato comune. Il
  bootstrap carica i grafi di include canonici di backup/restore prima delle librerie step Moodle 2, l'exit
  documentato di Psalm con finding è consultivo e i report PHPStan interni/incompleti restano bloccanti. Servono
  nuove esecuzioni Moodle 5.0 e 5.3 per costruire le prime baseline di risanamento valide.

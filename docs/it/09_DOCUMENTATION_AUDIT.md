...
- Marker documentali, README principali e artefatti ER identificano 1.7.121 / 2026090401.
...
- La guida GitHub Actions documenta trigger, permessi minimi, matrice Moodle/PHP/database a sei job, controlli
  bloccanti e consultivi, log conservati, faildump e l'attuale confine di configurazione PHPStan/Psalm.

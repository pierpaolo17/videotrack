...
Baseline: VideoTrack **1.7.132** (`2026091202`).
...
- Marker documentali, README principali e artefatti ER identificano 1.7.132 / 2026091202.
...
- I dieci file di produzione che consumano globali o contenitori forniti dai loader Moodle includono dichiarazioni
  `@var` circoscritte. Documentano il contratto esistente senza assegnare valori o sopprimere finding non correlati.

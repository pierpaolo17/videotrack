...
- Marker documentali, README principali e artefatti ER identificano 1.7.144 / 2026091801.
...
- Il risultato PHPMD generico 1.7.123 (215 finding in 42 file, nessun errore strumento) resta un riferimento
  ...
  release 1.7.144 affronta due flag booleani interni con API esplicite per ambito del delimitatore e limite della data,
  senza cambiare valori persistiti o regole degli analizzatori.

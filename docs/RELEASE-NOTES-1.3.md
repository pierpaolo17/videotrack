...
- `1.3.82`: stable maintenance checkpoint for packaging/docs static gate consistency.

- `1.3.84`: post-release maintenance checkpoint for stable packaging, docs, and static gate consistency.

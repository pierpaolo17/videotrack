...
La release 1.4.96 non modifica le funzionalità didattiche. Ripristina il modulo AMD `core/api/scope` estratto nella release precedente, includendo sia il sorgente sia il build AMD, e aggiunge il savepoint documentale mancante per la release 1.4.93.
